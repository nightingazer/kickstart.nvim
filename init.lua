...
local godot_projectfile, _ = loadfile(vim.fn.getcwd() .. 'project.godot')
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          nmap('<leader>op', ':NvimTreeToggle<CR>', 'Toggle NvimTree')
          nmap('<leader>oP', ':NvimTreeFindFile<CR>', 'Find file in NvimTree')
          ...
          if client and client.name == 'html' and client.server_capabilities then
